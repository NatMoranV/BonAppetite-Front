...
import { faPepperHot, faTimes, faCircleCheck } from '@fortawesome/free-solid-svg-icons'
import { FontAwesomeIcon } from '@fortawesome/react-fontawesome'
import styled, { css, keyframes } from 'styled-components'
import { CTAsContainer } from '../CTAs/CTAsContainer'

export const Modal = ({ isLoader, title, msg, text1, onClick1, text2, onClick2, onClose, iconOK }) => {
	return (
		<StyledModal>
			...
			<ModalContainer>
				...
				{isLoader ? (
					...
					<>
						...
						{text1 && <CTAsContainer text1={text1} onClick1={onClick1} text2={text2} onClick2={onClick2} />}
					</>
				)}
			</ModalContainer>
		</StyledModal>
